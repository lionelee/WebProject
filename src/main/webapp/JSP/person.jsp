						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form class="form" enctype="multipart/form-data" action="user_edit" method="post" id="fm">
										...
										<div class="form-group input-group">
            								...
            								<textarea class="form-control" rows="2" name="intro" id="Intro">
            								</textarea>
       		 							</div>
...
<script>
	...
	function edit(){
		...
		$('#image').fileinput('refresh',{
			...
			maxFileCount: 1,
			allowedFileExtensions : ['jpg','png','gif'],
			initialPreview: ["<img src='user_img?uid=<%=u.getUid()%>' class='file-preview-image'/>"]
		});
